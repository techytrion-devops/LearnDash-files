...
if (
	...
	class Learndash_Admin_Import_Handler extends Learndash_Admin_Import_Export_Handler {
		...
		public function handle(): void {
			...
			/****** Custom Changes Start ******* Comment sanitize_text_field and pass direct File Array *************/
			...
			/****** Custom Changes End ********** Comment sanitize_text_field and pass direct File Array ************/
		 ...
		 */
		public function enqueue_import_task( array $file_path ) {

			$zip_archive = new ZipArchive();

			/****** Custom Changes Start ******* Unzip file first then read data of configuration only *************/
			
			/****** Custom Code *******/

			$directoryName = trim(str_replace('import', '\ ', "import"));

			$zip_archive->open( $file_path['tmp_name'] );
			...
			$import_options = file_get_contents($working_directory . $directoryName . $options_file_name);

			/****** Custom Changes End ********** Unzip file first then read data of configuration only ************/
